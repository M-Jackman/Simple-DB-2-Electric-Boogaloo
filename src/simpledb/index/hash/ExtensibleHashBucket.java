...
public class ExtensibleHashBucket {
    ...
    //CS4432 Sets the search key and creates a new TableScan
    ...
    // CS4432 Gets the Rid of a record
    ...
    //CS4432 Adds an element from the EHI
    ...
    //CS4432 Removes an element from the EHI
    ...
    //CS4432 Checks to see if the index is full
    ...
    //CS4432 Copies information from a separate bucket b into a hash
